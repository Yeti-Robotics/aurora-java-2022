...
public class CommandsModule {
  ...
  @Provides
  public ToggleIntakeCommand provideToggleIntakeCommand(
  ...
  public Command provideTwoBall(
    ...
    return AutoHelper.buildAutonomousCommand(
        new Command[] {
          new ToggleIntakeCommand(intakeSubsystem),
          new AllInCommand(intakeSubsystem, neckSubsystem).withTimeout(3.0),
          new WaitCommand(3.0),
          new ToggleIntakeCommand(intakeSubsystem),
          new WaitCommand(1.0),
          new AllInCommand(intakeSubsystem, neckSubsystem).withTimeout(1.0),
  ...
  public Command provideTwoBallAlt(
    ...
    return AutoHelper.buildAutonomousCommand(
        new Command[] {
          ...
          new ToggleFlywheelHighCommand(shooterLEDCommand),
          new WaitCommand(3.0),
          new AllInCommand(intakeSubsystem, neckSubsystem).withTimeout(2.0),
          new ToggleFlywheelHighCommand(shooterLEDCommand)
        },
        new Command[] {
          ...
          new InstantCommand(
              () ->
                  ShooterSubsystem.setPoint =
                      ((25 / 3.0) * PhotonVision.getDistance()) + 2991.66667),
          new ToggleFlywheelHighCommand(shooterLEDCommand),
          new WaitCommand(1.0),
          new AllInCommand(intakeSubsystem, neckSubsystem).withTimeout(3.0),
          new ToggleFlywheelHighCommand(shooterLEDCommand)
  ...
  public Command provideFourBall(
    ...
    return AutoHelper.buildAutonomousCommand(
        new Command[] {
          ...
          new AllInCommand(intakeSubsystem, neckSubsystem).withTimeout(1.5),
          new InstantCommand(() -> ShooterSubsystem.setPoint = 4400.0),
          ...
          new ToggleIntakeCommand(intakeSubsystem),
          new AllInCommand(intakeSubsystem, neckSubsystem, 0.375).withTimeout(4.25),
          new WaitCommand(2.5),
          ...
          new AllInCommand(intakeSubsystem, neckSubsystem).withTimeout(0.4),
          new WaitCommand(0.5),
          new AllInCommand(intakeSubsystem, neckSubsystem).withTimeout(0.7),
          new InstantCommand(() -> ShooterSubsystem.isShooting = false),
  ...
  public Command provideThreeBall(
    ...
    return AutoHelper.buildAutonomousCommand(
        new Command[] {
          new ToggleIntakeCommand(intakeSubsystem),
          new AllInCommandGroup(intakeSubsystem, neckSubsystem).withTimeout(2.0),
          new ToggleIntakeCommand(intakeSubsystem),
          ...
          new WaitCommand(0.25),
          new AllInCommand(intakeSubsystem, neckSubsystem).withTimeout(0.75),
          new ToggleFlywheelHighCommand(shooterLEDCommand),
          new WaitCommand(1.0),
          new ToggleIntakeCommand(intakeSubsystem),
          new AllInCommandGroup(intakeSubsystem, neckSubsystem).withTimeout(3.0),
          new InstantCommand(() -> ShooterSubsystem.setPoint = 3800.0),
          new ToggleFlywheelHighCommand(shooterLEDCommand),
          new WaitCommand(1.25),
          new AllInCommand(intakeSubsystem, neckSubsystem).withTimeout(0.5),
  ...
  public Command provideTwoBallDump(
    ...
    return AutoHelper.buildAutonomousCommand(
        new Command[] {
          ...
          new ToggleFlywheelHighCommand(shooterLEDCommand),
          new ToggleIntakeCommand(intakeSubsystem),
          new AllInCommand(intakeSubsystem, neckSubsystem).withTimeout(4),
          new WaitCommand(2),
          new ToggleIntakeCommand(intakeSubsystem),
          new AllOutCommand(intakeSubsystem, neckSubsystem).withTimeout(1.5)
        },
        new Command[] {
          AutoHelper.runTrajectoryPath(
              drivetrainSubsystem, Constants.AutoConstants.twoBallPrimary1),
          AutoHelper.runTrajectoryPath(
              drivetrainSubsystem, Constants.AutoConstants.twoBallPrimary2),
