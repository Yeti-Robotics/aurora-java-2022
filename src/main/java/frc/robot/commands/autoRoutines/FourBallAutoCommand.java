...
public class FourBallAutoCommand extends SequentialCommandGroup {
  ...
  public SequentialCommandGroup fourBall;

  public FourBallAutoCommand(DrivetrainSubsystem drivetrainSubsystem, IntakeSubsystem intakeSubsystem,
    ...
    fourBall = new SequentialCommandGroup(new WaitCommand(1), IntakeInCommand.withTimeout(1), NeckInCommand.withTimeout(1), new WaitCommand(1), IntakeInCommand.withTimeout(1), NeckInCommand.withTimeout(1), new WaitCommand(1)); // do the waits stuffs
