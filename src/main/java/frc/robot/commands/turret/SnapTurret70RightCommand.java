...
public class SnapTurret70RightCommand extends CommandBase {

  private final TurretSubsystem turretSubsystem;
  private double limit;

  public SnapTurret70RightCommand(TurretSubsystem turretSubsystem) {
  ...
  public void initialize() {
    ...
    if (currEncoder >= TurretConstants.TURRET_MAX_RIGHT) {
      limit = 0.0; // stop
    } else if (currEncoder >= TurretConstants.TURRET_70_RIGHT) {
      limit = TurretConstants.TURRET_MAX_RIGHT;
    } else {
      limit = TurretConstants.TURRET_70_RIGHT;
    }
  }
