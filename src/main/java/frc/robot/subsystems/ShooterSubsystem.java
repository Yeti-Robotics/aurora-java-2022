...
public class ShooterSubsystem extends SubsystemBase {
  ...
  public ShooterSubsystem() {
    ...
    frontShooterPID =
        new PIDController(
            ShooterConstants.FRONT_SHOOTER_P,
            ShooterConstants.FRONT_SHOOTER_I,
            ShooterConstants.FRONT_SHOOTER_D);

    backShooterPID =
        new PIDController(
            ShooterConstants.BACK_SHOOTER_P,
            ShooterConstants.BACK_SHOOTER_I,
            ShooterConstants.BACK_SHOOTER_D);
  }
  ...
  public void periodic() {
    ...
    if (shooterMode == ShooterMode.HIGH_GOAL) {
      ...
      shootFlywheels(
          ShooterConstants.FRONT_SHOOTER_F
              + frontShooterPID.calculate(getFrontFlywheelSurfaceVelocity(), frontSetPoint),
          ShooterConstants.BACK_SHOOTER_F
              + backShooterPID.calculate(getBackFlywheelSurfaceVelocity(), backSetPoint));
    } else {
  ...
  public void shootFlywheels(double frontSpeed, double backSpeed) {
    ...
    shooterStatus =
        (frontSpeed > 0.0 && backSpeed > 0.0) ? ShooterStatus.FORWARD : ShooterStatus.BACKWARDS;
  }
  ...
  public void setFlywheelVelocities(double frontVel, double backVel) {
    ...
    shooterStatus =
        (frontVel > 0.0 && backVel > 0.0) ? ShooterStatus.FORWARD : ShooterStatus.BACKWARDS;
  }
