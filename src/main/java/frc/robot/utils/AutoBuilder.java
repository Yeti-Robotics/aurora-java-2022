...
public class AutoBuilder {
  ...
  private void scuffedThree() {
    ...
    pathCommandGroup.addCommands(
        runTrajectoryPath(AutoConstants.scuffedThree1),
        new WaitCommand(2.75),
        runTrajectoryPath(AutoConstants.scuffedThree2));
